package com.example.tech_exam_api_java.service;

import com.example.tech_exam_api_java.model.Product;
import com.example.tech_exam_api_java.repository.ProductRepository;
...
public class ProductService {
    ...
    public Product updateProduct(Long id, Product productDetails) {
        ...
        if (productDetails.getRequirements() != null) product.setRequirements(productDetails.getRequirements());
